...
float steeringPosition = 0; //from steering sensor
...
void loop()
{
  ...
  if (currentTime - lastTime >= LOOP_TIME)
  {
   ...
   // steeringPosition = (setCurve / 5) + steerSettings.wasOffset ; //bit shift by 2  0 to 13610 is 0 to 5v
 ...
 steerAngleActual = (float)canSteerPosition/800;
    //Ackerman fix
